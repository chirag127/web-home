...
import {
  FinishSignIn as ChromeFinishSignIn,
  type FinishSignInProps,
} from '@chirag127/astro-chrome/FinishSignIn'
...
export default function FinishSignIn(
  props: Omit<FinishSignInProps, 'auth'> & { auth?: FinishSignInProps['auth'] },
) {
